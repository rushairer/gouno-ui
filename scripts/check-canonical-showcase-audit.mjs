...
for (const evidence of [
  ...
  "csa-product-gosso-overview-role-mobile",
  "csa-product-gosso-account-mfa-mobile",
  "csa-product-gosso-clients-confidential-secret",
  "csa-product-gosso-users-role-update",
  "csa-product-gosso-audit-filtered-detail",
  "csa-product-gosso-site-settings-dirty-mobile",
  "csa-product-gosso-system-status-degraded",
