...
for (const evidence of [
  ...
  "csa-product-blog-account-notifications-read-mobile",
  "csa-product-blog-account-notifications-error",
  "csa-product-blog-account-settings-boundary",
  "csa-product-blog-account-settings-missing-url-mobile",
  "csa-product-blog-not-found-recovery-mobile",
