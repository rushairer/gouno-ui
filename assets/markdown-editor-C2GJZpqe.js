import{E as e,h as t,l as n,n as r,t as i,w as a}from"./typography-DRwFz_U2.js";import{n as o,t as s}from"./markdown-preview-NBdQ-hHA.js";import{Ct as c,Gt as l,d as u,p as d,rt as f,u as p}from"./index-BepV8MFb.js";var m=e(a(),1),h=t(),g=[1,2,3,4,5,6],_=[`## MarkdownEditor`,``,"这是一个 **加粗**、*斜体*、~~删除线~~、`inline code` 和 [链接](https://example.com) 的示例。",``,`> toolbarActions 只提供扩展槽，AI 写作、插图等业务由产品自己注入。`,``,`- [x] 编辑 / 分屏 / 预览`,`- [ ] 接入产品自己的保存与发布流程`,``,`| 能力 | 归属 |`,`| --- | --- |`,`| Markdown 命令 | MarkdownEditor |`,`| AI / 媒体 | 产品扩展 |`,``,"```ts",`const editor = { mode: "split", ready: true };`,"```"].join(`
