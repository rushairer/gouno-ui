...
export const CardTitle = ({ className, ...props }: CardTitleProps) => <h3 {...props} data-slot="card-title" data-typography-role="compact" className={cn("type-compact-title", className)} />;
export const CardDescription = ({ className, ...props }: CardDescriptionProps) => <p {...props} data-slot="card-description" data-typography-role="body-sm" className={cn("mt-1 type-body-sm text-muted-foreground", className)} />;
