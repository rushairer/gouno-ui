...
export { Heading, Text, Typography, type HeadingProps, type TextProps, type TypographyProps, type HeadingLevel, type HeadingVariant, type TextSize, type TextTone, type TextWeight, type TextFamily, type TextLeading } from "./typography";
