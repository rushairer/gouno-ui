...
export { Spinner, Progress, AspectRatio, Kbd, Typography, type SpinnerProps, type ProgressProps, type AspectRatioProps, type KbdProps, type TypographyProps } from "./visual";
...
export { Heading, Text, type HeadingProps, type TextProps, type HeadingLevel, type TextSize, type TextTone } from "./typography";
