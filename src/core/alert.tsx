    ...
    >
      ...
      {isClosable ? (
        <button
          ...
          className={cn("-mr-1 inline-flex size-7 shrink-0 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-foreground/5 hover:text-foreground focus-control dark:hover:bg-foreground/10", rich && "-mt-0.5", semanticClassNames.close)}
