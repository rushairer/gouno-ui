...
export function Space({ orientation = "horizontal", gap: gapValue = "md", align, wrap = false, block = false, split, children, className, ...props }: SpaceProps) {
  ...
  return <div {...props} data-slot="space" data-orientation={orientation} data-block={block || undefined} className={cn(
    "flex min-w-0",
