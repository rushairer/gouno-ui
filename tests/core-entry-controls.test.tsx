...
describe("Core data entry controls", () => {
  ...
  it("supports rating selection", () => { render(<Rate aria-label="Rating" defaultValue={2} />); fireEvent.click(screen.getByRole("radio", { name: "4" })); expect((screen.getByRole("radio", { name: "4" }) as HTMLInputElement).checked).toBe(true); });
