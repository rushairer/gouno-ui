...
export const showcaseCatalog: { group: string; items: ShowcasePage[] }[] = [
  { group: "General", items: [item("core-button", "Button 按钮"), item("core-icon", "Icon 图标"), item("core-typography", "Typography 排版"), item("core-kbd", "Kbd 按键"), item("core-badge", "Badge 标签"), item("core-avatar", "Avatar 头像")] },
  ...
  { group: "Data Display", items: [item("core-list", "List 列表"), item("core-descriptions", "Descriptions"), item("core-calendar", "Calendar"), item("core-image", "Image 图片"), item("core-carousel", "Carousel"), item("core-table", "Table 表格"), item("core-statistic", "Statistic 统计数值"), item("core-timeline", "Timeline 时间轴"), item("core-tree", "Tree 树")] },
