...
export const showcaseCatalog: { group: string; items: ShowcasePage[] }[] = [
  ...
  { group: "Layout 布局", items: [
    item("core-space", "Space", "间距", 95), item("core-flex", "Flex", "弹性布局", 78), item("core-grid", "Grid", "网格", 72), item("core-separator", "Separator", "分隔线", 90), item("core-card", "Card", "卡片", 82), item("core-splitter", "Splitter", "分隔面板", 68), item("core-page-layout", "Layout", "页面布局", 75),
  ] },
