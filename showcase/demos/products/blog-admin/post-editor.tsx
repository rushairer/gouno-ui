...
function renderPostPreview(value: string) {
  ...
  return (
    <article className="mx-auto max-w-3xl space-y-4" data-slot="post-markdown-preview">
      {source.split(/\n{2,}/).map((block, index) => {
