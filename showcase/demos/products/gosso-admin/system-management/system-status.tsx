...
export function SystemStatusPanel() {
  ...
  const [scenario, setScenario] = useState<SystemScenario>("healthy");
  ...
  return (
    <div className="flex flex-col gap-5">
      <FixtureBanner
        ...
        note="系统状态 Fixture 的健康、检查中、部分异常与不可用场景只存在于 Showcase 工具层；真实产品画布不再出现切换 Fixture 的按钮。"
      ...
      {scenario === "checking" ? (
        ...
        <>
          ...
          <Card padding="base">
            <div className="mb-4"><Heading level={2} className="text-base">基础设施健康</Heading><Text size="sm" tone="muted" className="mt-1">数据库与 Redis 是 GOSSO 会话、锁和身份数据的关键依赖。</Text></div>
