...
export const dataDisplayDocuments: Record<string, ComponentDocument> = {
  ...
  "data-table": { title: "DataTable 数据表格", description: "面向业务列表的排序、筛选、分页、行选择、展开行、禁用行和状态原语。", code: dataTableCode, render: () => <DataTableDemo />, api: [{ name: "children", description: "直接组合 Table 子元素", type: "ReactNode" }, { name: "columns", description: "列定义", type: "DataTableColumn<T>[]" }, { name: "dataSource", description: "行数据", type: "T[]" }, { name: "rowKey", description: "稳定行键", type: "keyof T | function" }, { name: "loading", description: "加载状态", type: "boolean" }, { name: "loadingRows", description: "加载骨架行数", type: "number" }, { name: "loadingCols", description: "加载骨架列数", type: "number" }, { name: "empty", description: "强制空状态", type: "boolean" }, { name: "emptyState", description: "空状态覆盖内容", type: "ReactNode" }, { name: "className", description: "外层类名", type: "string" }, { name: "density", description: "表格密度", type: "TableDensity" }, { name: "selectable", description: "启用行选择", type: "boolean" }, { name: "selectedRowKeys", description: "受控选中键", type: "string[]" }, { name: "onSelectionChange", description: "选中变化回调", type: "function" }, { name: "defaultSort", description: "非受控初始排序", type: "DataTableSortState" }, { name: "sort", description: "受控排序状态", type: "DataTableSortState" }, { name: "onSortChange", description: "排序变化回调", type: "function" }, { name: "filter", description: "行过滤函数", type: "(record: T) => boolean" }, { name: "pagination", description: "受控或非受控分页", type: "DataTablePagination | false" }, { name: "bordered", description: "显示表格边框", type: "boolean" }, { name: "stickyHeader", description: "固定表头", type: "boolean" }, { name: "rowDisabled", description: "禁用指定行", type: "(record: T) => boolean" }, { name: "expandedRowKeys", description: "受控展开键", type: "string[]" }, { name: "defaultExpandedRowKeys", description: "非受控初始展开键", type: "string[]" }, { name: "onExpandedRowsChange", description: "展开变化回调", type: "function" }, { name: "expandedRowRender", description: "展开行内容", type: "(record, index) => ReactNode" }, { name: "locale", description: "空状态和分页文案", type: "DataTableLocale" }] },
