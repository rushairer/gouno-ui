...
export const coreDocuments: Record<string, ComponentDocument> = { ...generalDocuments, ...badgeDocuments, ...tagDocuments, ...layoutDocuments, ...dataEntryDocuments, ...segmentedDocuments, ...navigationDocuments, ...dataDisplayDocuments, ...feedbackDocuments, ...alertDocuments, ...otherDocuments };
