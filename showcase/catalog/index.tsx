...
export const showcaseCatalog: ShowcaseGroup[] = [
  { workspace: "gouno-ui", layer: "core", group: "General 通用", items: [
    ...
    item("core-avatar", "Avatar", "头像", 100, <CircleUserRound />),
  ]},
  ...
  { workspace: "gouno-ui", layer: "patterns", group: "Composition Contracts 组合契约", items: [
    ...
    item("pattern-settings-composition", "Settings", "设置组合", 100, <SlidersHorizontal />),
    item("pattern-data-summary-composition", "DataSummary", "数据摘要", 100, <Gauge />),
  ]},
  ...
  { workspace: "blog-admin", group: "Content 内容管理", items: [
    ...
    item("blog-admin-post-editor", "PostEditor", "文章编辑器", 100, <FileText />),
